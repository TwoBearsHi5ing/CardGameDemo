...
public class DeckBuilder : MonoBehaviour 
{
    ...
    private HeroAsset buildingForCharacter;
    ...
    public void BuildADeckFor(HeroAsset asset)
    {
        ...
        // apply character faction and activate tab.
        DeckBuildingScreen.Instance.TabsScript.SetClassOnClassTab(asset.faction);
        DeckBuildingScreen.Instance.CollectionBrowserScript.ShowCollectionForDeckBuilding(asset.faction);
    ...
    public void DoneButtonHandler()
    {
        ...
        DeckInfo deckToSave = new DeckInfo(deckList, DeckName.text, buildingForCharacter.faction, buildingForCharacter);
